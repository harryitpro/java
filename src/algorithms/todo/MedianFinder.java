...
public class MedianFinder {
     ...
     * If you only need the median without full sorting,
     * you can use the QuickSelect algorithm (O(n) on average), which is a modified version of QuickSort that only finds the K-th smallest element.
     */
