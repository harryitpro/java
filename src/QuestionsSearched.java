/**
 * eBay interview questions vary depending on the role (Software Engineer, SDE, QA, etc.) and experience level. Below are some commonly asked Java-based coding, system design, and behavioral questions:
 *
 * 1. Coding Questions (DSA & Java)
 * eBay typically asks DSA-focused questions in Leetcode Medium/Hard range.
 *
 * Array & String
